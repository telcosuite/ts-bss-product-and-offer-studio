...
- App writes stay inside `product_offer_studio`; cross-app collaboration must use APIs, events, workflow tasks, governed projections, or data products.
- TMF review status: Complete (see `docs/planning/tmf-api-to-ddl-review.md` for the full V001/V00X baseline rationale); DDL baseline status: Complete; starter tables: see `database/postgres/source-migrations/V003__refine_product_offer_studio_tmf_core.sql`.

## Discovered Phase Summary

| Phase | Phase file | Rationale | Exit gate | Status | Notes |
| --- | --- | --- | --- | --- | --- |
| P01 - From Scratch App Foundation And Delivery Runtime | [P01-from-scratch-app-foundation-and-delivery-runtime.md](P01-from-scratch-app-foundation-and-delivery-runtime.md) | Bootstrap GitHub app repository `ts-bss-product-and-offer-studio` and app-root runtime before feature implementation because planning has no runnable app implementation. | Clean checkout of `ts-bss-product-and-offer-studio` can run the frontend/backend, migrate the app schema, validate Docker Compose and Kubernetes/Helm, run CI smoke checks, and prove the first UI/API/database/audit-event vertical slice. | Not Started | Updated to align with app-repo strategy. |
| P02 - Phase 2 Foundation | [P02-phase-2-foundation.md](P02-phase-2-foundation.md) | Build the first feature-area foundation specific to Product And Offer Studio before the next set of capability slices can be built. | First feature-area foundation in `product_offer_studio` is testable against the V001/V00X migrations and TMF-aligned APIs. | Not Started | Generated from source feature pack. |
| P03 - Phase 3 Expansion | [P03-phase-3-expansion.md](P03-phase-3-expansion.md) | Expand the first feature area and connect to the second feature area specific to Product And Offer Studio. | Second feature area is testable and emits or consumes the first feature area's events. | Not Started | Generated from source feature pack. |
| P04 - Phase 4 Cross Area | [P04-phase-4-cross-area.md](P04-phase-4-cross-area.md) | Wire cross-area handoffs, lifecycle transitions, and downstream events for Product And Offer Studio. | Cross-area handoffs and event publication are tested end to end. | Not Started | Generated from source feature pack. |
| P05 - Phase 5 Release Readiness | [P05-phase-5-release-readiness.md](P05-phase-5-release-readiness.md) | Complete release-gate evidence, observability, runbooks, and support handoff for Product And Offer Studio. | App release evidence covers privacy, audit, observability, accessibility, support, and post-launch monitoring. | Not Started | Generated from source feature pack. |

## From-Scratch Build Artifact Checklist

| Artifact area | Default target | Completion evidence |
| --- | --- | --- |
| GitHub app repository | `ts-bss-product-and-offer-studio` | Repository exists with `README.md`, `OWNERS.md`, `CODEOWNERS`, branch protection, required checks, security scanning, and copied `dev-tasks/` from planning. |
...
| PostgreSQL | `database/postgres/migrations/` and `database/postgres/seeds/` | Clean app-repo migration run, app-owned tables for schema `product_offer_studio`, idempotency/audit/outbox, seed/demo data, and rollback/repair notes. |
...
| --- | --- | --- | --- | --- |
| [agreement-and-contract](../planning/app-detail/features/agreement-and-contract.md) | `features/agreement-and-contract.md` | derived | P02-P05 | Not Started |
| [catalog-governance](../planning/app-detail/features/catalog-governance.md) | `features/catalog-governance.md` | derived | P02-P05 | Not Started |
| [offer-launch-readiness-and-test-catalog](../planning/app-detail/features/offer-launch-readiness-and-test-catalog.md) | `features/offer-launch-readiness-and-test-catalog.md` | derived | P02-P05 | Not Started |
| [pricing-promotion-and-discount](../planning/app-detail/features/pricing-promotion-and-discount.md) | `features/pricing-promotion-and-discount.md` | derived | P02-P05 | Not Started |
| [product-catalog](../planning/app-detail/features/product-catalog.md) | `features/product-catalog.md` | derived | P02-P05 | Not Started |
| [product-configuration](../planning/app-detail/features/product-configuration.md) | `features/product-configuration.md` | derived | P02-P05 | Not Started |
| [product-sunset-grandfathering-and-migration](../planning/app-detail/features/product-sunset-grandfathering-and-migration.md) | `features/product-sunset-grandfathering-and-migration.md` | derived | P02-P05 | Not Started |
| [tax-revenue-account-and-regulatory-filing](../planning/app-detail/features/tax-revenue-account-and-regulatory-filing.md) | `features/tax-revenue-account-and-regulatory-filing.md` | derived | P02-P05 | Not Started |
