# Product And Offer Studio P04 - Phase 4 Cross Area Development Tasks
...
Phase rationale: Wire cross-area handoffs, lifecycle transitions, and downstream events for Product And Offer Studio.
...
- [offer-launch-readiness-and-test-catalog](../planning/app-detail/features/offer-launch-readiness-and-test-catalog.md)
- [product-sunset-grandfathering-and-migration](../planning/app-detail/features/product-sunset-grandfathering-and-migration.md)

## Phase Tasks

### DT-01-product-and-offer-studio-P04-T001: Implement P04 - Phase 4 Cross Area enablement and cross-feature controls

| Field | Value |
| --- | --- |
| Phase | P04 - Phase 4 Cross Area |
| Priority | P0 |
| Source evidence | [App README](../README.md), [Modules and features](../planning/app-detail/modules-and-features.md), [Personas and journeys](../planning/app-detail/personas-and-user-journeys.md), [Suite data model](../../data-model.md), [TMF review](../../tmf-api-ddl-reviews/product-offer-studio.md) |
| Feature or module | Phase enablement and cross-feature controls |
| Build area | API/Data/Event |
| Dependencies | DT-01-product-and-offer-studio-P03-T012 (or earlier phase exit gate) |
...
- Confirm phase scope, exit gate, source evidence, app-owned schema `product_offer_studio`, TMF/API posture (TMF620, TMF671, TMF760, TMF651, TMF633, TMF634), migration order, and no-direct-cross-app-write rules.
...
- Feature specs in this phase: offer-launch-readiness-and-test-catalog, product-sunset-grandfathering-and-migration.
...
### DT-01-product-and-offer-studio-P04-T002: Implement feature-slice coverage and tracker linkage for P04 - Phase 4 Cross Area
...
| Dependencies | DT-01-product-and-offer-studio-P04-T001 |
...
- Source features covered in this phase: offer-launch-readiness-and-test-catalog, product-sunset-grandfathering-and-migration.
...
### DT-01-product-and-offer-studio-P04-T003: Prove phase readiness with end-to-end, contract, accessibility, event replay, and reconciliation evidence
...
| Dependencies | DT-01-product-and-offer-studio-P04-T002 |
