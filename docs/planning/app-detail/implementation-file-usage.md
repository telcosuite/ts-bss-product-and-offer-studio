# Product And Offer Studio Implementation File Usage

Reviewed: 2026-06-14

## Purpose

Use this guide when building `Product And Offer Studio`. It explains which generated files matter, when to read them, and how they drive Angular, Spring Boot, PostgreSQL, TMF API, event, and privacy work.
...
| App overview | [../product-and-offer-studio.md](../product-and-offer-studio.md) | Concise product scope, app purpose, TMF API usage, ownership, integrations, and first-release direction. |
...
| App TMF review | [../../tmf-api-ddl-reviews/product-offer-studio.md](../../tmf-api-ddl-reviews/product-offer-studio.md) | TMF APIs, resource-to-table mapping, field handling, event baseline, privacy/retention/audit baseline. |
...
| App V002+ migration | [../../../../database/postgres/suites/ts_bss_commercial/V003__refine_product_offer_studio_tmf_core.sql](../../../../database/postgres/suites/ts_bss_commercial/V003__refine_product_offer_studio_tmf_core.sql) | Promotes common TMF columns and creates app support tables, event_contract, and privacy_retention_policy. |
...
9. Use `product_offer_studio.event_contract` as the baseline event register and `product_offer_studio.event_outbox` for publication.
10. Use `product_offer_studio.privacy_retention_policy` as the baseline for masking, audit, retention, legal hold, and residency handling.
...
- Write only inside schema `product_offer_studio` for this app's operational data.
